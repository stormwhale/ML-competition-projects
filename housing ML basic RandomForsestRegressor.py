...
# import sample file
data = pd.read_csv(
    "https://raw.githubusercontent.com/stormwhale/ML-competition-projects/refs/heads/main/melb_data.csv"
)
...
X_train[
    mia_col
].isnull().sum() / 13580 * 100  # determine the precentage of missing data.
...
my_pipe2 = Pipeline([("im", SimpleImputer()), ("model", model)])
